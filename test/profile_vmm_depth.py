...
def map_with_profile(catalog,points,
    ...
    if save != None:
        ...
        map_path = os.path.join(save[1],f"map_{save[0]}.pdf")
        profile_path = os.path.join(save[1],f"profile_{save[0]}.pdf")
...
if __name__ == "__main__":
    ...
    # events = "/home/emmanuel/Tesis/data/map/vmm_eqt.csv"
    # events = "/home/emmanuel/Tesis/data/map/vmm_eqt_HYPO.csv"
    events = "/home/emmanuel/EDCT/EQviewer/data/earthquakes/events_20160101T20220901_NLLOC_ok.csv"
    ...
    # width = [-40,40]
    depth = [-3,200]
    profile_figsize = ("20c", "20c")
    # profile_figsize = None
    name = "vmm_1"
    # name = "mesetas_nodetail_pnet"
    # name = "nido_plate_sgc"
    folder = "/home/emmanuel/Tesis/data/map/vmm_hypo"
